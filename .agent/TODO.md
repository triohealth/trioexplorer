...
- [x] 2. Keep Step 1: Discover Available Cohorts (already good)
  - Updated to remove search index reference in namespace description
...
- [x] 8. Update Step 6: Advanced Filters
  - Renamed from "search index Filters"
  - Removed all "search index" terminology
...
- [x] 9. Update Step 7: Filter Field Discovery
  ...
  - Removed search index references
...
- [x] 11. Update Summary section
  ...
  - Removed any remaining search index/entitlements mentions
